...
const proxyIPs = ['36.95.152.58:12137'];
		...
		try {
			...
			if (request.headers.get('Upgrade') !== 'websocket') {
    		    ...
    		    if (url.pathname === '/vless') {
    				...
    				const content = getConfig(userIDs[0], host, proxyAddresses);
...
function GenSub(userID_path, hostname, proxyIP) {
	...
	const mainDomains = new Set([
		...
		// '115155.xyz',                    // 18ip/1å°æ¶
		// 'cdn.2020111.xyz',               // 15ip/10min
		'cfip.cfcdn.vip',                // 6ip/1å¤©
		proxyIPs,
		// æå¨æ´æ°åæªç¥é¢ç
		'cf.0sm.com',                    // æå¨æ´æ°
		'cloudflare-ip.mofashi.ltd',     // æªç¥é¢ç
		'cf.090227.xyz',                 // æªç¥é¢ç
		'cname.xirancdn.us',             // æªç¥é¢ç
		// 'f3058171cad.002404.xyz',        // æªç¥é¢ç
		'cf.zhetengsha.eu.org',          // æªç¥é¢ç
		'cloudflare.9jy.cc',             // æªç¥é¢ç
		// '8.889288.xyz',                  // æªç¥é¢ç
		'cf.zerone-cdn.pp.ua',           // æªç¥é¢ç
		'cfip.1323123.xyz',              // æªç¥é¢ç
		'cdn.tzpro.xyz',                 // æªç¥é¢ç
		'cf.877771.xyz',                 // æªç¥é¢ç
		'cnamefuckxxs.yuchen.icu',       // æªç¥é¢ç
		'cfip.xxxxxxxx.tk',              // OTCå¤§ä½¬æä¾ç»´æ¤
	]);
