...
async function handleRequest(request) {
  if (request.method === 'GET') {
    // Menyajikan halaman HTML ketika ada request GET
    const htmlContent = `
      <!DOCTYPE html>
      <html lang="en">
      <head>
  ...
  if (request.method === 'POST' && request.url.endsWith('/create-account')) {
    ...
    // Simpan data ke Cloudflare KV
    await VLESS_KV.put(username, JSON.stringify(data));  // Menyimpan username dan data konfigurasi
